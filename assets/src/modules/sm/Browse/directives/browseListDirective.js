    ...
    return {
        ...
        link: {
            pre: function(scope, elm, attrs) {
                ...
                var itemName = hierarchy[hIndex], childrenName = hierarchy[hIndex + 1] + "s", entityDataRequestMethodName = "get" + capitalize(childrenName) + "For" + capitalize(itemName);
