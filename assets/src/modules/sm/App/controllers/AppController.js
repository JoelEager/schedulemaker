angular.module("sm").controller("AppController", function($scope, localStorage, $window, $filter, $state, $stateParams) {
    ...
    $scope.courseCart = {
        ...
        selection: {
            ...
            section: {
                ...
                isByCourse: function(course, section) {
                    return $scope.courseCart.contains.course(course) && section.selected;
                }
            },
            course: {
                /**
                ...
                toggle: function(course) {
                    ...
                    course.selected = !$scope.courseCart.selection.course.toggleAllSections(Ecourse);
                },
                is: function(course) {
                    if ($scope.courseCart.contains.course(course)) {
                        return $scope.courseCart.selection.course.allSections($scope.courseCart.ensure.course(course));
                    } else {
                        return false;
                    }
                },
                ...
                toggleAllSections: function(course) {
                    var setTo = !$scope.courseCart.selection.course.allSections(course);
                ...
                allSections: function(course) {
                    return course.sections.reduce(function(total, section) {
            ...
            course: function(course) {
                ...
                if ($scope.state.courses.indexOf(course) == -1) {
                    ...
                    if ($scope.courseCart.contains.course(course)) {
                        ...
                        ensuredCourse = $scope.courseCart.create.fromExistingCourse(course);
                    }
                } else {
            ...
            section: function(section) {
                if ($scope.courseCart.contains.section(section)) {
                    ...
                    return $scope.courseCart.add.sectionToCourse(section, foundCourse);
                } else {
                    return $scope.courseCart.create.fromExistingSection(section);
                }
            }
        },
        contains: {
        ...
        create: {
            ...
            blankCourse: function() {
                return $scope.courseCart.add.courseToCart($scope.courseCart.getBlankCourse(true));
            },
            /**
    ...
    $scope.ui = {
        ...
        colors: [ "#7BA270", "#85B4C2", "#CD9161", "#74B79F", "#AA9E5B", "#769E9F", "#9D987A", "#658B76", "#92838F", "#A9ABC3" ]
    };
});